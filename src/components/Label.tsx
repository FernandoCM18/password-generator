...
export const Label = () => {
  ...
  const test = evaluatePassword(password);
  console.log(test);
  
  return (
    <div className="flex justify-between items-center bg-gray-100 p-5">
      <p className="text-gray-500">{password || 'Genera tu contraseña'}</p>
      <svg className="fill-blue-700" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
