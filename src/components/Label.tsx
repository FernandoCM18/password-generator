...
export const Label = ({text, copyClipboard}: Props) => {
  ...
  return (
    <div className="flex justify-between items-center bg-gray-100 dark:bg-slate-800 p-5">
      ...
      <svg onClick={handleCopyClipboard} className={`${text ? 'fill-blue-700' : 'fill-gray-500'} ${text.length === 0 && 'cursor-not-allowed'}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
